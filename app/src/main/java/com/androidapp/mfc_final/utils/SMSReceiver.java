package com.androidapp.mfc_final.utils;
...
import com.androidapp.mfc_final.Login;
...
class SMSReciver extends BroadcastReceiver {
    ...
    public void setOTPListener(Login otpListener) {
        SMSReciver.this.otpListener = (OTPReceiveListener) otpListener;
    }
